...
-- AddForeignKey
ALTER TABLE "public"."LedgerBalance" ADD CONSTRAINT "LedgerBalance_debtorId_fkey" FOREIGN KEY ("debtorId") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."LedgerBalance" ADD CONSTRAINT "LedgerBalance_creditorId_fkey" FOREIGN KEY ("creditorId") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."NetDebtSummary" ADD CONSTRAINT "NetDebtSummary_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
